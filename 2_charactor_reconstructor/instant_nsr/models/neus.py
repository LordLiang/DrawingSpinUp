...
class NeuSModelTextureMLP(BaseModel):
    def setup(self):
    ...
    def isosurface(self, front_mask=None):
        mesh = self.geometry.isosurface(front_mask)
        return mesh
    ...
    def export(self, export_config, front_mask=None):
        ...
        mesh['verts'] = mesh['verts'].numpy()
        mesh['vert_colors'] = rgb
