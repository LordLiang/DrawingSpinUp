...
if __name__ == "__main__":
    ...
    parser.add_argument('--no_alpha', action='store_true', help='save images without alpha channel')
    ...
    for test_name in testing_name_list:
        ...
        dataset = DatasetFullImages(data_root, pre_dir, use_mask, use_pos, use_edge)
